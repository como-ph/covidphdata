...
Using the list of files or folders in the specified *Google Drive*, the `datadrop_id_file` function can be used to extract the *Google Drive* ID of the file to be retrieved.
